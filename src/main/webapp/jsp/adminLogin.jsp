...
<c:if test="${!empty sessionScope.adminLoginSuc}">
    <script>
        alert("登陆成功！");
        ...
        <%--window.location.href = "${pageContext.request.contextPath}/admin/getUserByUS";--%>
    </script>
    <%
        session.removeAttribute("adminLoginSuc");
    %>
</c:if>
...
<div class="container">
    ...
    <div class="con-box right">
        ...
        <img src="${pageContext.request.contextPath}/imgs/img1.jpeg" alt="">
        <p><a href="${pageContext.request.contextPath}/goRegister" style="text-decoration: none;">我是用户？</a></p>
        <p>没有账号？</p>
